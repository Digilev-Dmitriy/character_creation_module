...
def attack(char_name: str, char_class: str | None) -> str | None:
...
def defence(char_name: str, char_class: str | None) -> str | None:
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str | None) -> str | None:
    if char_class == 'warrior':
        return (
